...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DVXcoin " + FormatFullVersion();
...
{
    CAddress seed1;
    OpenNetworkConnection(seed1, NULL, "185.82.20.11");
    CAddress seed2;
    OpenNetworkConnection(seed2, NULL, "185.82.20.112");

    CAddress explorer;
    OpenNetworkConnection(explorer, NULL, "185.82.23.57");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DVXcoin is probably already running."), addrBind.ToString());
        else
